<%@page import="dinax.projeto.core.util.ConverteDate"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1"%>

<%@ page
	import="dinax.projeto.core.aplicacao.Resultado, dinax.projeto.dominio.*, java.util.*"%>
...
<%
	...
	<form action="SalvarProduto" method="post">
		...
		<input type="text" id="txtQtd" name="txtQtd" value=
